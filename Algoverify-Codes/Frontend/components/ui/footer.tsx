...
export default function Footer() {
  return (
    <footer>
      <div className="bg-purple-600/80 py-12 md:py-16">
...
{/* 
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">AlgoTrust</div>
            </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-200 font-medium mr-4">&copy; AlgoTrust. All rights reserved.</div>
