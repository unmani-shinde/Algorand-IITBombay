...
export default function Testimonials() {
  return (
    <section>
      <div id = "testimonials" className="max-w-6xl mx-auto px-4 mb-8 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">

          {/* Section header */}
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Unparalleled Support and Expertise</h2>
            <p className="text-xl text-gray-400">In life's gallery, moments are like precious brushstrokes on the canvas of our journey, each memory adding depth to the tapestry that defines us.</p>
          </div>
