      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className='ml-12 mt-16'>
            <h1 className="text-5xl font-extrabold text-zinc-200 mb-12 mt-20" data-aos="fade-right">
              Don't hire liars.
            </h1>
            <p className="text-lg text-gray-500 mb-12" data-aos="fade-right" data-aos-delay="100">
